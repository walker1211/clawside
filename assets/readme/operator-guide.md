[Back to README](../../README.md) | [中文](./operator-guide.zh-CN.md)

# Clawside operator guide

This file preserves the detailed runbook that used to live in the root README. The root README now stays short and links here for operator-level detail.
