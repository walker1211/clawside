...
func TestTelegramOperatorLifecycleScripts(t *testing.T) {
	...
	for _, want := range []string{
		...
		"CLAWSIDE_TELEGRAM_OPERATOR_DB_PATH",
		"CLAWSIDE_TELEGRAM_OPERATOR_BASE_URL",
		"CLAWSIDE_TELEGRAM_OPERATOR_OPENCLAW_COMMAND",
		"CLAWSIDE_TELEGRAM_OPERATOR_OPENCLAW_ARGS",
		"CLAWSIDE_TELEGRAM_OPERATOR_AGENT_TIMEOUT",
		"OPENCLAW_COMMAND=\"${CLAWSIDE_TELEGRAM_OPERATOR_OPENCLAW_COMMAND:-}\"",
		"IFS=',' read -r -a OPENCLAW_ARGS",
		"AGENT_TIMEOUT=\"${CLAWSIDE_TELEGRAM_OPERATOR_AGENT_TIMEOUT:-}\"",
		"--openclaw-command",
		"--openclaw-arg",
		"--agent-timeout",
